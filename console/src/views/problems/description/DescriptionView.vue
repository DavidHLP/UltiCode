  ...
  <section class="space-y-6">
    <section class="space-y-3">
      ...
      <div ref="accordionSection" class="mt-4 flex flex-col gap-3">
        ...
        <Accordion type="multiple" class="w-full divide-y divide-border/20 border-t border-b border-border/30">
          <!-- Related Tags -->
          <AccordionItem
            v-if="props.problem.tags?.length"
            ref="tagsSection"
          ...
          >
            <AccordionTrigger class="text-xs hover:no-underline py-2.5 px-1 hover:bg-[var(--silver-100)]/30 transition-colors">
              <div class="flex items-center gap-2 text-[var(--solarized-base01)] dark:text-[var(--solarized-base1)]">
                ...
                <span class="font-bold uppercase tracking-wider text-[11px]">{{ t("problem.detail.tags") }}</span>
              </div>
            </AccordionTrigger>
          ...
          >
            <AccordionTrigger class="text-xs hover:no-underline py-2.5 px-1 hover:bg-[var(--silver-100)]/30 transition-colors">
              <div class="flex items-center gap-2 text-[var(--solarized-base01)] dark:text-[var(--solarized-base1)]">
                ...
                <span class="font-bold uppercase tracking-wider text-[11px]">{{ t("problem.detail.hints") }}</span>
              </div>
            </AccordionTrigger>
            <AccordionContent class="pb-3 pt-1">
