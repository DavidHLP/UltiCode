export default {
  ...
  storeErrors: {
    ...
    problems: {
      fetchFailed: '获取题目列表失败',
      fetchOneFailed: '获取题目失败',
      createFailed: '创建题目失败',
      updateFailed: '更新题目失败',
      deleteFailed: '删除题目失败',
    ...
    contests: {
      fetchFailed: '获取比赛列表失败',
      fetchOneFailed: '获取比赛失败',
      createFailed: '创建比赛失败',
      updateFailed: '更新比赛失败',
      deleteFailed: '删除比赛失败',
      startFailed: '开始比赛失败',
    ...
    tags: {
      ...
      deleteFailed: '删除标签失败',
      mergeFailed: '合并标签失败',
      bulkDeleteFailed: '批量删除标签失败',
    },
    problemLists: {
      fetchFailed: '获取题目列表失败',
      fetchOneFailed: '获取题目列表失败',
      createFailed: '创建题目列表失败',
      updateFailed: '更新题目列表失败',
      deleteFailed: '删除题目列表失败',
      updateProblemsFailed: '更新题目失败',
    },
    solutions: {
      fetchFailed: '获取题解列表失败',
      fetchOneFailed: '获取题解失败',
      deleteFailed: '删除题解失败',
      flagFailed: '标记题解失败',
      unflagFailed: '取消标记失败',
    },
    forum: {
      fetchFailed: '获取论坛帖子失败',
      fetchOneFailed: '获取帖子失败',
      deleteFailed: '删除帖子失败',
      pinFailed: '置顶失败',
      unpinFailed: '取消置顶失败',
      lockFailed: '锁定失败',
  ...
  apiToast: {
    users: {
      ...
      permissionRevoked: '权限撤销成功',
      passwordReset: '密码重置成功',
      batchProcessed: '已成功处理 {count} 位用户',
    },
    audit: {
      exported: '审计日志导出成功',
    },
    ...
    contests: {
      ...
      ended: '比赛已结束',
      problemAdded: '题目已添加到比赛',
      problemRemoved: '题目已从比赛移除',
      batchProcessed: '已成功处理 {count} 场比赛',
    },
    tags: {
      created: '标签创建成功',
      updated: '标签更新成功',
      deleted: '标签删除成功',
      merged: '标签合并成功',
      batchProcessed: '已成功处理 {count} 个标签',
    },
    problemLists: {
      created: '题目列表创建成功',
      updated: '题目列表更新成功',
