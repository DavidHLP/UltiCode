...
class NotificationChannelContractTest {
    ...
    private static NotificationIntent sampleFollow() {
        // Use the static factory that takes primitives so no User entity is needed.
        return FollowReceivedIntent.of(
                "follower-1", "alice", "user-1", java.time.Clock.systemDefaultZone());
    }
