...
<template>
  <Card
    ...
    class="gap-0 py-0 overflow-hidden rounded-none border-[var(--silver-200)] dark:border-[var(--silver-300)]/60 shadow-sm"
  >
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4">
      <section
        v-for="(group, groupIndex) in groups"
        :key="group.title"
        class="min-w-0 border-b border-[var(--silver-200)] dark:border-[var(--silver-300)]/40 md:[&:nth-last-child(-n+2)]:border-b-0 xl:border-b-0 xl:border-r xl:last:border-r-0"
      >
        <header
        ...
        <dl class="divide-y divide-[var(--silver-100)] dark:divide-[var(--silver-200)]/20 px-4">
          <div
