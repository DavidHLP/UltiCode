...
| 文件                                           | 作用                                                                 | 负责人     | 最后更新 |
| ---------------------------------------------- | ----------------------------------------------------------------------- | --------- | ------------ |
| [[CONTRIBUTING]]         | 开发环境搭建、代码风格、PR 清单、评审礼仪                   | architect | 2026-06-19   |
| [[RUNBOOK]]                   | On-call 手册：启动、健康检查、常见问题、回滚      | devops    | 2026-06-19   |
| [[ENV]]                           | `.env` / Nacos / Vite 中每一个环境变量 — 含来源      | backend   | 2026-06-19   |
| [[DOCS_CONVENTIONS]] | 在本目录树下如何编写、命名、打标签、归档、链接文档      | architect | 2026-06-19   |

## 3. 子目录

| 路径                                            | 作用                                                                                                                            | 何时往这里加文档                          |
| ----------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------- |
| [[CODEMAPS/README]]                      | 自动生成的架构快照：拓扑、模块、schema、依赖、沙箱。由 `ecc:update-codemaps` 更新。                | 系统级架构 / 模块地图          |
| [[adr/README]]                                | 架构决策记录（Architecture Decision Records）— 一个不那么显然的选择背后的**原因**                                                               | 不那么显然、横切多端、难以回退    |
| [[ops/README]]                                | 运维深读：Arthas MCP、日志查询、工具参考                                                               | 具体工具或场景的参考（非政策） |
| [[theme/README]]                            | 前端主题系统：Token、颜色模式、密度、组件原语、扩展指南 | 改前端颜色/字体/密度/动效、加新主题或新密度档 |
...
| 在 code review 里为一个不那么显然的设计决策举证       | 在 [[adr/README]] 下写一篇新 ADR（模板：[[adr/README]]） |
| 改前端颜色 / 字体 / 密度 / 加新主题                  | [[theme/README]] 整套（6 篇，按需挑） + `.claude/rules/frontend-rules.md` |
...
| 修改前端主题（颜色/字体/密度） | [[theme/README]] 全套 + `frontend-rules.md`  |
