...
contains .github/actions/host-deploy/action.yml 'remote sandbox prerequisites ready'
contains .github/actions/host-deploy/action.yml 'test -f \"\$SANDBOX_HOST_DIR/seccomp-profile.json\"'
...
contains .github/actions/host-deploy/action.yml 'SANDBOX_HOST_DIR must be absolute'
