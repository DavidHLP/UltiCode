    ...
    >
      ...
      >
        ...
        <div class="flex items-center gap-2">
          ...
          <span class="font-data text-sm text-[var(--terminal-cyan)]">{{ t('problems.edit.code') }}</span>
        </div>
        <div class="flex items-center gap-2">
          <IconBrackets class="h-4 w-4 text-[var(--silver-400)]" />
        ...
        <div class="ml-auto hidden sm:flex items-center gap-2 text-[var(--silver-400)]">
          ...
          <span class="text-xs font-data uppercase tracking-wider">{{ t('problems.edit.languageConfig') }}</span>
        </div>
      </div>
    </div>
