 ...
 *
 * <p>Provider lives in {@code backend-app} (submission module) and
 * executes every query inside the App owner; the Admin consumer depends
 * only on this entity-free contract. Pagination, filter and sort
