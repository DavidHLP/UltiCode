...
contains docs/OPERATIONS.md '本仓库不承诺 active-active HA'
...
contains docs/OPERATIONS.md 'masteruser ulticode-replication'
contains docs/OPERATIONS.md 'sentinel auth-user'
contains docs/OPERATIONS.md 'sentinel auth-user mymaster ulticode-sentinel'
contains docs/OPERATIONS.md 'P3-HA-001'
contains docs/OPERATIONS.md 'mysql-replica'
contains docs/OPERATIONS.md 'redis-sentinel-1'
