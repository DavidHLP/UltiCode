 ...
 *
 * <p>AUTH-COMP-007: supports HS256 for the overlap period and RS256.
 ...
 * HS256 remains available for tokens issued before the RS256 cutover, but
 * an unavailable or missing JWKS key never falls back from an RS256 token
 * to HS256 verification.
 */
@Slf4j
@Component
