...
nohup java -jar "${REPO_ROOT}/backend-spring/backend-auth/target/app.jar" \
...
nohup java -jar "${REPO_ROOT}/backend-spring/backend-admin/target/app.jar" \
...
nohup java -jar "${REPO_ROOT}/backend-spring/backend-app/target/app.jar" \
