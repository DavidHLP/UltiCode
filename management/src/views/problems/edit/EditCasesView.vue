    ...
    >
      ...
      >
        ...
        <div class="flex items-center gap-2">
          ...
          <span class="font-data text-sm text-[var(--terminal-cyan)]">{{ t('problems.edit.testCases') }}</span>
        </div>
        <div class="flex items-center gap-2">
        ...
        <div class="ml-auto hidden sm:flex items-center gap-2 text-[var(--silver-400)]">
          ...
          <span class="text-xs font-data uppercase tracking-wider">{{ t('problems.edit.testCaseEditor') }}</span>
        </div>
      </div>
    </div>
