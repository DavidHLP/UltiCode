---
name: backend-09-java-runtime-diagnostics
description: Arthas / JVM runtime diagnostics guardrails (unconditional; trigger-driven).
globs: []
condition: ["(?i)Runtime|diagnostics|guardrails"]
interruptMode: never
alwaysApply: false
---
