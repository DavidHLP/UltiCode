  ...
  apps: [
    ...
    },
    {
      ...
      env: {
        ...
        APP_STORAGE_S3_ACCESS_KEY: process.env.RUSTFS_ADMIN_ACCESS_KEY,
        APP_STORAGE_S3_SECRET_KEY: process.env.RUSTFS_ADMIN_SECRET_KEY,
    ...
    },
    {
      ...
      env: {
        ...
        APP_STORAGE_S3_ACCESS_KEY: process.env.RUSTFS_APP_ACCESS_KEY,
        APP_STORAGE_S3_SECRET_KEY: process.env.RUSTFS_APP_SECRET_KEY,
        INTERNAL_DELEGATION_PUBLIC_KEY: process.env.INTERNAL_DELEGATION_PUBLIC_KEY,
        INTERNAL_DELEGATION_KEY_ID: process.env.INTERNAL_DELEGATION_KEY_ID,
        INTERNAL_DELEGATION_AUDIENCE: 'backend-app',
        APP_RUNTIME_MODE: process.env.APP_RUNTIME_MODE === 'dev-full' ? 'dev-full' : 'dev-lite',
