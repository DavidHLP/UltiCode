...
class InAppNotificationChannelTest {
    ...
    void followIntentIdDedupsPerDayFollowingD10() {
        ...
        FollowReceivedIntent first = FollowReceivedIntent.of("follower-1", "alice", "target-1", day1);
        FollowReceivedIntent refollowSameDay = FollowReceivedIntent.of("follower-1", "alice", "target-1", day1);
        FollowReceivedIntent refollowLaterDay = FollowReceivedIntent.of("follower-1", "alice", "target-1", day2);
