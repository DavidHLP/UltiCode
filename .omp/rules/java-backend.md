---
name: java-backend
description: Java 17, Spring Boot, mapper, service, entity, security, testing, and review guardrails for backend changes.
globs:
  - services/**/*.java
  - services/**/*.yml
  - services/**/*.yaml
  - services/**/*.properties
condition: ["(?i)Java|Spring|MyBatis|security|JUnit|mapper|transaction"]
interruptMode: never
alwaysApply: false
---
