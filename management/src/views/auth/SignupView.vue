 ...
 * SignupView - 注册页面
 *
 * 使用 AuthGrid 背景 + AuthCard 容器 + SignupForm
 */
  ...
  <div class="auth-layout">
    ...
    <div class="auth-layout__form-side">
      ...
      <div class="auth-layout__content">
        <AuthCard title="register.terminal">
          <SignupForm />
        </AuthCard>
      </div>
    ...
    <AuthGrid>
      <div class="auth-pattern-text">
        ...
        <h2 class="auth-pattern-text__title">Join the<br />Team</h2>
        <p class="auth-pattern-text__subtitle">// Create your administrator account</p>
