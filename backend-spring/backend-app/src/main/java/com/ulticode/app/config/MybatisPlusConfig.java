...
/**
 * MyBatis-Plus configuration for the backend-app service shell.
 *
 ...
 *
 * <p>The pagination interceptor is owned here as well because read projections
 * call {@code selectPage}; without it the service shell would not enforce the
 * public page/limit contract. Optimistic-locking and cross-owner interceptors
