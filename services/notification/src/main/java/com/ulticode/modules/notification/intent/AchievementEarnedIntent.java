 ...
 * {@code BadgeEarnedPayload}, not the generic
 ...
 * to the typed broadcast method. The two-channel split is the one remaining
...
public record AchievementEarnedIntent(
    ...
    public NotificationPayload toPushPayload() {
        throw new UnsupportedOperationException(
                "AchievementEarnedIntent must be pushed as BadgeEarnedPayload; "
                        + "the channel handles this with a single instanceof");
    }
