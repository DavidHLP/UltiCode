...
INSERT INTO `forum_comments` (`id`, `post_id`, `parent_id`, `author_id`, `body`, `markdown`, `created_at`, `edited_at`, `is_pinned`, `is_locked`, `is_flagged`, `flagged_reason`, `flagged_at`, `is_deleted`, `deleted_at`, `deleted_by`) VALUES ('c-seg-2','post-segtree-visual','c-seg-1','user-tourist','Fixed! Thanks. 🙏',NULL,NOW(3),NULL,0,0,0,NULL,NULL,0,NULL,NULL);
...
INSERT INTO `forum_comments` (`id`, `post_id`, `parent_id`, `author_id`, `body`, `markdown`, `created_at`, `edited_at`, `is_pinned`, `is_locked`, `is_flagged`, `flagged_reason`, `flagged_at`, `is_deleted`, `deleted_at`, `deleted_by`) VALUES ('c-seg-5','post-segtree-visual','c-seg-3','user-max','Check out JiDriver\'s blog for beats visuals.',NULL,NOW(3),NULL,0,0,0,NULL,NULL,0,NULL,NULL);
...
INSERT INTO `forum_comments` (`id`, `post_id`, `parent_id`, `author_id`, `body`, `markdown`, `created_at`, `edited_at`, `is_pinned`, `is_locked`, `is_flagged`, `flagged_reason`, `flagged_at`, `is_deleted`, `deleted_at`, `deleted_by`) VALUES ('c-tilt-3','post-contest-tilt','c-tilt-2','user-lily','Also, stand up. Physically changing your posture resets the \"tunnel vision\".',NULL,NOW(3),NULL,0,0,0,NULL,NULL,0,NULL,NULL);
...
INSERT INTO `forum_community_rules` (`id`, `community_id`, `title`, `body`, `sort_order`, `created_at`) VALUES ('rule-interview-1','community-interview','尊重他人','Everyone\'s interview experience is different. Be supportive and constructive.',1,NOW(3));
