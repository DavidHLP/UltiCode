...
/**
 * Default backend-auth implementation of the password reset workflow.
 *
 * <p>The broad account port and reset-token candidate scan remain internal
 * storage details. The HTTP adapter depends only on {@link PasswordResetWorkflow}.
 * The storage strategy and token format are intentionally unchanged.</p>
 */
@Slf4j
@Service
@RequiredArgsConstructor
public class DefaultPasswordResetWorkflow implements PasswordResetWorkflow {
