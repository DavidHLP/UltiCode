...
- Active task: P0-SEC-007 deployment SSH host identity; P0-SEC-004, P0-SEC-005, and P0-SEC-006 are complete with Redis runtime integration externally blocked.
...
- Next: require per-environment known_hosts, reject disabled host-key checking, and make rotation fail closed; then isolate Nacos credentials.
