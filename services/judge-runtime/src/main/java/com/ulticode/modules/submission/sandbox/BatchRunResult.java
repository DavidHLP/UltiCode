 ...
 * {@code com.ulticode.modules.submission.service.VerdictResolver}. Keeping the port free of verdict-reduction logic
 ...
 * the list with one
 * {@link SubmissionStatus#SANDBOX_ERROR} per input test case so the caller
