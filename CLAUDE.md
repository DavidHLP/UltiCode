...
Use `mcp__plugin_context-mode_context-mode__ctx_execute` for `./mvnw` and `pnpm` (type-check/lint/test) — Bash redirects them to ctx_execute anyway. Direct ctx_execute saves the redirect-error round-trip.
