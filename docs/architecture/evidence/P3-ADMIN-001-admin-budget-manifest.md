...
| `E-NOTIFY-WRITE` | `services/admin/src/main/java/com/ulticode/modules/admin/service/impl/AdminNotificationServiceImpl.java:78-201` (historical snapshot: this row originally also listed `NotificationCutoverService.java:49-253`; that twin was deleted in the round-3 review, C2 — see the 2026-09-16 amendment above). |
