---
description: Runtime and infrastructure rules (Docker, Compose, PM2).
globs:
- .env.example
...
- Base and production Compose configurations **MUST NOT** publish infrastructure or backend ports; development exposure belongs exclusively in `docker/docker-compose.dev.yml` bound to loopback.
