...
public class Submission {
    ...
    /**
     * Generation fence token (M3b). Monotonically incremented on every
     ...
     * (M3b). {@code null} when the submission is not being judged.
    ...
    /**
     * Absolute expiry of the current JUDGING lease (M3b). The worker
