  ...
  <CheckboxRoot
    ...
    :class="
      cn(
        ...
        // Terminal variant
        variant === 'terminal' && [
          'border-[var(--border-subtle)] dark:border-[var(--foreground-muted)] data-[state=checked]:bg-primary data-[state=checked]:text-primary-foreground data-[state=checked]:border-[var(--primary)] focus-visible:border-[var(--primary)] focus-visible:ring-[var(--accent-glow)] rounded-none shadow-none focus-visible:ring-[2px]',
        ],
        props.class,
      )
    "
