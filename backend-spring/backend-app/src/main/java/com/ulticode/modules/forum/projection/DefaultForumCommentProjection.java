 ...
 * carried by {@code ForumCommentServiceImpl}.
 *
...
public class DefaultForumCommentProjection implements ForumCommentProjection {
    ...
    @Override
    public ForumCommentVO toCommentVO(ForumComment comment, Map<String, ForumUserReadPort.UserSummary> authorMap) {
        ...
        ForumUserReadPort.UserSummary author = authorMap.get(comment.getAuthorId());
        if (author != null) {
