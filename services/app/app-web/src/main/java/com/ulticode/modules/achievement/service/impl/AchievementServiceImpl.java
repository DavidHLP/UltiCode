 ...
 *
 * <p>Read paths were extracted into {@link AchievementProjection} (the current projection seam).
 ...
 * ModerationProjection {@code toAppealVO} pattern (the existing projection pattern).</p>
 */
@Slf4j
@Service
