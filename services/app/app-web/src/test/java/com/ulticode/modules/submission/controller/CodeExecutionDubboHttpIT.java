...
class CodeExecutionDubboHttpIT {
    ...
    private static ServiceConfig<JudgeRunService> service;
    private static ReferenceConfig<JudgeRunService> reference;
    private static ReferenceConfig<JudgeRunService> missingReference;
    ...
    static void setUp() {
        ...
        service.setInterface(JudgeRunService.class);
        ...
        reference.setInterface(JudgeRunService.class);
        ...
        missingReference.setInterface(JudgeRunService.class);
