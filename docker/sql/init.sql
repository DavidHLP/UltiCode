...
create database if not exists `spring_oj`
...
VALUES (71, 1, '29efc2bd1c0a44f1965cc4950af33d85d7283d0f4d22de652df317137a4d4fb8', 'access', 0, '2025-10-20 10:00:00',
        '2025-10-27 10:00:00');
INSERT INTO `auth_tokens`
VALUES (72, 1, '7ab1a6d4c1d78e5ff62ab3b7c4c685d7b19d9506b477a1f9c3b0c261d5bc4a21', 'refresh', 0, '2025-10-20 10:00:00',
        '2025-11-19 10:00:00');
...
-- ----------------------------
INSERT INTO `security_audit_logs` (`id`, `actor_id`, `actor_username`, `action`, `object_type`, `object_id`,
                                   `description`, `diff_snapshot`, `ip_address`, `created_at`)
VALUES (1, 1, 'DavidHLP', 'ROLE_PERMISSION_UPDATED', 'role', '3', '调整管理员角色权限集合',
        JSON_OBJECT('before', JSON_ARRAY('problem.view', 'problem.manage'), 'after',
                    JSON_ARRAY('problem.view', 'problem.manage', 'user.manage')), '127.0.0.1', '2025-10-20 10:05:00');
...
VALUES (1, NULL, 0, NULL, NULL, '2025-10-15 08:47:45', '2025-10-17 13:13:57');
...
VALUES (1, 1, 'admin-console', '0bb2d4d5aa744913b4050a4f27191d58e92d8fd10f2cbb73c6bd348c21f1a908', 'dashboard',
        '2025-10-20 12:00:00', '2025-10-20 09:30:00');
...
VALUES ('203.0.113.10', '疑似撞库', '2025-10-19 20:00:00', '2025-11-19 20:00:00');
...
-- ----------------------------
INSERT INTO `bookmarks` (`user_id`, `entity_type`, `entity_id`, `visibility`, `note`, `tags`, `source`, `created_at`,
                         `updated_at`)
VALUES (1, 'problem', 1, 'private', '常用题目，需二刷', JSON_ARRAY('数组', '技巧'), 'user', '2025-10-20 09:12:00',
        '2025-10-20 09:12:00'),
...
VALUES (1, 'algorithms', 'Algorithms');
INSERT INTO `categories`
VALUES (2, 'data-structures', 'Data Structures');
...
-- Records of comments
-- ----------------------------
INSERT INTO `comments` (`id`, `entity_type`, `entity_id`, `user_id`, `parent_id`, `status`, `visibility`, `content_md`,
                        `content_rendered`, `sensitive_flag`, `sensitive_hits`, `moderation_level`, `moderation_notes`,
                        `last_moderated_by`, `last_moderated_at`, `created_at`, `updated_at`)
VALUES (1, 'problem', 1, 1, NULL, 'approved', 'public', '这是一道很经典的题目，谢谢分享！', NULL, 0, NULL, 'low',
        '自动通过', 1, '2025-10-20 09:20:00', '2025-10-20 09:15:00', '2025-10-20 09:20:00'),
       (2, 'problem', 1, 1, 1, 'pending', 'public', '期待继续优化题解思路', NULL, 0, NULL, NULL, NULL, NULL, NULL,
        '2025-10-20 09:18:00', '2025-10-20 09:18:00');
...
VALUES (1, 1, '2025-10-20 09:05:00');

-- ----------------------------
-- Records of contest_registrations
-- ----------------------------
INSERT INTO `contest_registrations`
VALUES (1, 1, 1, 'approved', 'admin', '系统导入', 1, '2025-10-20 09:05:00', '2025-10-20 09:00:00',
        '2025-10-20 09:05:00');
...
VALUES (1, '秋季热身赛', '一次针对初学者的热身赛，包含两道基础题。', 'icpc', '2025-11-01 09:00:00', '2025-11-01 12:00:00',
        1, 1, '2025-10-20 09:00:00', '2025-10-20 09:00:00', 'open', '2025-10-15 00:00:00', '2025-10-31 23:59:59', NULL,
        20, 30, 1);
...
VALUES (1, 1, 'v1', 1, 'text', NULL, NULL, NULL, 1, '2025-10-17 16:53:25', '2025-10-17 16:53:25');
INSERT INTO `datasets`
VALUES (2, 2, 'v1', 1, 'text', NULL, NULL, NULL, 1, '2025-10-17 16:53:25', '2025-10-17 16:53:25');
...
-- ----------------------------
INSERT INTO `files`
VALUES (1, 'submissions/2025/10/17/1.cpp', '0f4b6cba72f787b8581fbc5eac109d3328d01fefbe17f4ad6d4b5d3c7f27e9a1',
        'text/x-c++src', 428, 1, '2025-10-17 17:44:00');
INSERT INTO `files`
VALUES (2, 'submissions/2025/10/17/1.log', '31ed948a9920ba63dd1d8c2f954ed7be16ceb2068aec1a51ad8f7c837f0e9b77',
        'text/plain', 182, 1, '2025-10-17 17:45:05');
INSERT INTO `files`
VALUES (3, 'submissions/2025/10/18/2.py', 'd755ca5ecd39919a4389d88bc54a8fdae8c09e24bb47e2d086e6c5b1e1f72cfa',
        'text/x-python', 312, 1, '2025-10-18 09:10:00');
INSERT INTO `files`
VALUES (4, 'submissions/2025/10/18/2.log', '18b3543ebb7f8c580c54529974a51835e1f3ff5ffc87dc5d5059070f0d1226c3',
        'text/plain', 512, 1, '2025-10-18 09:12:15');
INSERT INTO `files`
VALUES (5, 'submissions/2025/10/18/3.java', '0a3d93aee7d6daab6121fdf642e14e8f09db64a28fb7e5f0b8abb1fd997deff0',
        'text/x-java-source', 640, 1, '2025-10-18 09:30:00');
INSERT INTO `files`
VALUES (6, 'submissions/2025/10/18/3.log', '5a00be31054cf2bdbc83e92ed3524cd86f55f6aefe646fec4cb1b6f9fedfb511',
        'text/plain', 420, 1, '2025-10-18 09:31:10');
...
VALUES (1, 1, 1, 'finished', 0, '2025-10-17 17:46:00', '2025-10-17 17:46:05', '2025-10-17 17:46:07');
INSERT INTO `judge_jobs`
VALUES (2, 2, 2, 'running', 1, '2025-10-18 09:10:05', '2025-10-18 09:10:10', NULL);
INSERT INTO `judge_jobs`
VALUES (3, 3, 3, 'failed', 0, '2025-10-18 09:30:05', '2025-10-18 09:30:07', '2025-10-18 09:30:20');
...
VALUES (1, 'node-1', 'online', '{
  "cpu": "16c",
  "mem_gb": 32,
  "os": "Ubuntu 24.04"
}', '2025-10-17 17:50:00', '2025-10-15 08:00:00');
INSERT INTO `judge_nodes`
VALUES (2, 'node-2', 'busy', '{
  "cpu": "32c",
  "mem_gb": 64,
  "os": "Debian 12"
}', '2025-10-17 17:55:00', '2025-10-15 08:10:00');
INSERT INTO `judge_nodes`
VALUES (3, 'node-3', 'offline', '{
  "cpu": "8c",
  "mem_gb": 16,
  "os": "Ubuntu 22.04"
}', '2025-10-17 16:10:00', '2025-10-16 09:00:00');
...
VALUES (1, 'cpp17', 'C++17', NULL, 1);
INSERT INTO `languages`
VALUES (2, 'python3.11', 'Python 3.11', NULL, 1);
INSERT INTO `languages`
VALUES (3, 'java17', 'Java 17', NULL, 1);
...
VALUES (1, 'problem.view', '查看题目', '2025-10-14 08:00:00');
INSERT INTO `permissions`
VALUES (2, 'problem.manage', '管理题目', '2025-10-14 08:00:00');
INSERT INTO `permissions`
VALUES (3, 'contest.view', '查看比赛', '2025-10-14 08:00:00');
INSERT INTO `permissions`
VALUES (4, 'contest.manage', '管理比赛', '2025-10-14 08:00:00');
INSERT INTO `permissions`
VALUES (5, 'user.manage', '管理用户', '2025-10-14 08:00:00');
INSERT INTO `permissions`
VALUES (6, 'user.view', '查看用户', '2025-10-14 08:05:00');
INSERT INTO `permissions`
VALUES (7, 'role.manage', '管理角色', '2025-10-14 08:05:00');
INSERT INTO `permissions`
VALUES (8, 'permission.manage', '管理权限', '2025-10-14 08:05:00');
INSERT INTO `permissions`
VALUES (9, 'token.manage', '管理认证令牌', '2025-10-14 08:05:00');
INSERT INTO `permissions`
VALUES (10, 'audit.view', '查看审计日志', '2025-10-14 08:05:00');
INSERT INTO `permissions`
VALUES (11, 'security.policy.manage', '管理安全策略', '2025-10-14 08:05:00');
...
VALUES (201, 2, 'en', '344. Reverse String',
        ...
        '- 1 ≤ |s| ≤ 10^5', '**Example**\nInput: s = \"hello\"\nOutput: \"olleh\"', '2025-10-17 16:53:25',
        '2025-10-17 16:53:25');
INSERT INTO `problem_statements`
VALUES (202, 2, 'zh-CN', '344. 反转字符串',
        '编写函数返回字符串 **s** 的反转结果。\r\n  > 注：LeetCode 原题为原地修改字符数组，这里改为返回值版本以便判题。',
        '- 1 ≤ |s| ≤ 10^5', '**示例**\n输入：s = \"hello\"\n输出：\"olleh\"', '2025-10-17 16:53:25',
        '2025-10-17 16:53:25');
INSERT INTO `problem_statements`
VALUES (207, 1, 'en', '1. Two Sum',
        'Given an integer array **nums** and an integer **target**, return the indices of the two numbers such that they add up to **target**.',
        '- 2 ≤ |nums| ≤ 10^5\n- -10^9 ≤ nums[i], target ≤ 10^9\n- Exactly one solution exists.',
        '**Example**\nInput: nums = [2,7,11,15], target = 9\nOutput: [0,1]', '2025-10-17 18:06:54',
        '2025-10-17 18:06:54');
INSERT INTO `problem_statements`
VALUES (208, 1, 'zh-CN', '1. 两数之和',
...
-- ----------------------------
INSERT INTO `reactions` (`user_id`, `entity_type`, `entity_id`, `kind`, `weight`, `source`, `metadata`, `created_at`,
                         `updated_at`)
VALUES (1, 'problem', 1, 'like', 1, 'user', NULL, '2025-10-20 09:16:00', '2025-10-20 09:16:00'),
       (1, 'comment', 1, 'upvote', 1, 'system', JSON_OBJECT('reason', 'featured'), '2025-10-20 09:22:00',
        '2025-10-20 09:22:00');
...
-- ----------------------------
INSERT INTO `sensitive_words` (`id`, `word`, `category`, `level`, `replacement`, `description`, `is_active`,
                               `created_at`, `updated_at`)
VALUES (1, '违规示例', '违规', 'block', NULL, '命中即拦截', 1, '2025-10-20 08:00:00', '2025-10-20 08:00:00'),
...
-- ----------------------------
INSERT INTO `moderation_tasks` (`id`, `entity_type`, `entity_id`, `status`, `priority`, `source`, `risk_level`,
                                `reviewer_id`, `metadata`, `notes`, `created_at`, `updated_at`, `reviewed_at`)
VALUES (1, 'comment', 2, 'pending', 2, 'auto', 'medium', NULL, JSON_OBJECT('hits', JSON_ARRAY('待审核词')),
        '命中敏感词等待审核', '2025-10-20 09:18:10', '2025-10-20 09:18:10', NULL),
       (2, 'comment', 1, 'approved', 3, 'user_report', 'low', 1, JSON_OBJECT('reporterId', 2), '复核通过',
        '2025-10-19 10:18:10', '2025-10-19 11:00:00', '2025-10-19 11:00:00');
...
VALUES (1, 1, 'created', NULL, '系统自动创建审核任务', JSON_OBJECT('trigger', 'sensitive_word'), '2025-10-20 09:18:10'),
...
-- ----------------------------
INSERT INTO `roles`
VALUES (1, 'platform_admin', '平台管理员', '拥有全局账户与权限管理权限', '2025-10-15 08:40:00', '2025-10-17 14:15:41');
INSERT INTO `roles`
VALUES (2, 'user', '普通用户', '默认权限', '2025-10-15 08:47:45', '2025-10-17 14:15:54');
INSERT INTO `roles`
VALUES (3, 'admin', '管理员', '最高管理权限', '2025-10-17 12:28:09', '2025-10-17 14:15:41');
...
VALUES (1, 1, 'compile_log', 2, '2025-10-17 17:45:05');
INSERT INTO `submission_artifacts`
VALUES (2, 2, 'stderr', 4, '2025-10-18 09:12:15');
INSERT INTO `submission_artifacts`
VALUES (3, 3, 'compile_log', 6, '2025-10-18 09:31:10');
...
VALUES (1, 1, 1, 1, 'AC', 5, 1024, 10, NULL);
INSERT INTO `submission_tests`
VALUES (2, 1, 2, 1, 'AC', 6, 1100, 10, NULL);
INSERT INTO `submission_tests`
VALUES (3, 1, 3, 2, 'AC', 7, 1152, 10, NULL);
INSERT INTO `submission_tests`
VALUES (4, 1, 4, 2, 'AC', 8, 1200, 10, NULL);
INSERT INTO `submission_tests`
VALUES (5, 2, 1, 1, 'AC', 6, 1024, 10, NULL);
INSERT INTO `submission_tests`
VALUES (6, 2, 2, 1, 'WA', 7, 1100, 0, '输出与期望不一致');
INSERT INTO `submission_tests`
VALUES (7, 2, 3, 2, 'SKIP', NULL, NULL, 0, '依赖前置用例失败');
INSERT INTO `submission_tests`
VALUES (8, 2, 4, 2, 'SKIP', NULL, NULL, 0, '依赖前置用例失败');
...
VALUES (1, 1, 1, 1, 1, 1, 428, 'AC', 100, 12, 4096, '所有测试用例通过', '127.0.0.1', 1, '2025-10-17 17:45:00');
INSERT INTO `submissions`
VALUES (2, 1, 1, 1, 2, 3, 312, 'WA', 40, 68, 8192, '样例 2 输出不符', '127.0.0.1', NULL, '2025-10-18 09:10:00');
INSERT INTO `submissions`
VALUES (3, 1, 2, 1, 3, 5, 640, 'PD', NULL, NULL, NULL, NULL, '127.0.0.1', NULL, '2025-10-18 09:30:00');
...
-- ----------------------------
INSERT INTO `tags`
VALUES (3, 'string', 'String', '2025-10-17 16:53:25', '2025-10-17 16:53:25');
INSERT INTO `tags`
...
VALUES (1, 1, 'samples', 1, 1, '2025-10-17 16:53:25', '2025-10-17 16:53:25');
INSERT INTO `testcase_groups`
VALUES (2, 1, 'hidden', 0, 1, '2025-10-17 16:53:25', '2025-10-17 16:53:25');
INSERT INTO `testcase_groups`
VALUES (3, 2, 'samples', 1, 1, '2025-10-17 16:53:25', '2025-10-17 16:53:25');
INSERT INTO `testcase_groups`
VALUES (4, 2, 'hidden', 0, 1, '2025-10-17 16:53:25', '2025-10-17 16:53:25');
...
VALUES (1, 1, 1, NULL, NULL, '{
  ...
  0,
  1
]', 'json', 10, '2025-10-17 16:53:25', '2025-10-17 16:53:25');
INSERT INTO `testcases`
...
INSERT INTO `testcases`
VALUES (5, 3, 1, NULL, NULL, '{
  \"s\": \"hello\"
}', '\"olleh\"', 'json', 10, '2025-10-17 16:53:25', '2025-10-17 16:53:25');
INSERT INTO `testcases`
VALUES (6, 3, 2, NULL, NULL, '{
  \"s\": \"ab\"
}', '\"ba\"', 'json', 10, '2025-10-17 16:53:25', '2025-10-17 16:53:25');
INSERT INTO `testcases`
VALUES (7, 4, 1, NULL, NULL, '{
  \"s\": \"racecar\"
}', '\"racecar\"', 'json', 10, '2025-10-17 16:53:25', '2025-10-17 16:53:25');
INSERT INTO `testcases`
VALUES (8, 4, 2, NULL, NULL, '{
  \"s\": \"OpenAI GPT\"
}', '\"TPG IAnepO\"', 'json', 10, '2025-10-17 16:53:25', '2025-10-17 16:53:25');
...
VALUES (1, 2, '2025-10-17 13:13:45');
INSERT INTO `user_roles`
VALUES (1, 3, '2025-10-17 13:13:57');
INSERT INTO `user_roles`
VALUES (1, 1, '2025-10-20 09:30:00');
...
-- ----------------------------
INSERT INTO `users`
VALUES (1, 'DavidHLP', 'lysf15520112973@163.com', '$2a$12$YGHyAEo6oMy/uZzrgY.MBe2UP40qD62lMGlUU4UgH6dhwRE4r3D/W', NULL,
        NULL, 1, '2025-10-17 18:06:33', '127.0.0.1', '2025-10-15 08:47:45', '2025-10-17 18:06:33');

-- ----------------------------
-- View structure for vw_problem_stats
-- ----------------------------
DROP VIEW IF EXISTS `vw_problem_stats`;
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `vw_problem_stats` AS
...
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `vw_user_problem_best` AS
