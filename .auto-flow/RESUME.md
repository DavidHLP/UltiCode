...
- Active task: P0-SEC-008 Nacos credentials and modes; P0-SEC-004 through P0-SEC-007 are complete, with Redis runtime integration externally blocked.
...
- Next: isolate Nacos service credentials, explicit namespaces, and production cluster/standalone modes; then begin Submission owner mutation work.
