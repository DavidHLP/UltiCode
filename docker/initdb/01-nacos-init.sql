-- NOTE: This file only runs on FIRST MySQL initialization (empty volume).
-- If the volume already has data, MySQL skips /docker-entrypoint-initdb.d/
-- Create nacos_config database if not exists
