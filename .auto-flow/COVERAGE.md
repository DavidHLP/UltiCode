...
| Submission verdict/write path is single-hop and single-writer | CONTRACT-004, CONTRACT-007 | PARTIAL — source contracts/capabilities are migrated, but direct provider cutover, compat retirement, grants and runtime single-writer evidence remain blocked in CONTRACT-007 |
