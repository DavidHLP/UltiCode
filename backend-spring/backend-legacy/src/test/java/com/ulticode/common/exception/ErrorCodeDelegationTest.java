...
class ErrorCodeDelegationTest {
    ...
    void delegationMirrorsBaseErrorCode() {
        // SUCCESS
        assertThat(ErrorCode.SUCCESS.getCode()).isEqualTo(ErrorCode.SUCCESS.code());
        assertThat(ErrorCode.SUCCESS.getMessage()).isEqualTo(ErrorCode.SUCCESS.message());

        // 4xx ladder
        assertThat(ErrorCode.BAD_REQUEST.getCode()).isEqualTo(ErrorCode.BAD_REQUEST.code());
        assertThat(ErrorCode.VALIDATION_FAILED.getCode())
                .isEqualTo(ErrorCode.VALIDATION_FAILED.code());
        assertThat(ErrorCode.UNAUTHORIZED.getCode()).isEqualTo(ErrorCode.UNAUTHORIZED.code());
        assertThat(ErrorCode.FORBIDDEN.getCode()).isEqualTo(ErrorCode.FORBIDDEN.code());
        assertThat(ErrorCode.NOT_FOUND.getCode()).isEqualTo(ErrorCode.NOT_FOUND.code());
        assertThat(ErrorCode.METHOD_NOT_ALLOWED.getCode())
                .isEqualTo(ErrorCode.METHOD_NOT_ALLOWED.code());
        assertThat(ErrorCode.CONFLICT.getCode()).isEqualTo(ErrorCode.CONFLICT.code());
        assertThat(ErrorCode.TOO_MANY_REQUESTS.getCode())
                .isEqualTo(ErrorCode.TOO_MANY_REQUESTS.code());

        // 5xx ladder
        assertThat(ErrorCode.UNKNOWN_ERROR.getCode())
                .isEqualTo(ErrorCode.UNKNOWN_ERROR.code());
        assertThat(ErrorCode.DATABASE_ERROR.getCode())
                .isEqualTo(ErrorCode.DATABASE_ERROR.code());

        // Messages must also mirror, byte-for-byte.
        assertThat(ErrorCode.VALIDATION_FAILED.getMessage())
                .isEqualTo(ErrorCode.VALIDATION_FAILED.message());
        assertThat(ErrorCode.NOT_FOUND.getMessage())
                .isEqualTo(ErrorCode.NOT_FOUND.message());
        assertThat(ErrorCode.DATABASE_ERROR.getMessage())
                .isEqualTo(ErrorCode.DATABASE_ERROR.message());
    }
