var VueDndKitDevtools = (function (devtoolsApi, vue) {
  'use strict';
  ...
  function setupDevtools(app) {
      devtoolsApi.setupDevtoolsPlugin({
          ...
          const store = app.__VUE_DND_KIT_STORE__;
          api.addInspector({
              id: inspectorId,
              label: 'DnD Kit',
              icon: 'drag_indicator',
          ...
          vue.watch(() => store, () => api.sendInspectorState(inspectorId), { deep: true });
  ...
  function setupDndKitDevtools(app) {
  ...
  return setupDndKitDevtools;

})(VueDevtoolsApi, Vue);
//# sourceMappingURL=vue-dnd-kit-devtools.global.js.map
