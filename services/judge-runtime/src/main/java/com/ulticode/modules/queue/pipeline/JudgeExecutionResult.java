 ...
 * @param testCaseDetails  entity-free per-case detail list (caseId + caseScope
 *                         populated when sourced from the canonical test_cases table)
 */
public record JudgeExecutionResult(
        SubmissionStatus status,
        int maxRuntimeMs,
        double maxMemoryMb,
        List<JudgeTestCaseDetail> testCaseDetails
) {
}
