...
/**
 * Wire-level names and claims for the signed internal delegation assertion.
 *
 * <p>The assertion travels as a transport attachment only; the receiving
 * owner must verify its signature and claims before trusting it.
 */
