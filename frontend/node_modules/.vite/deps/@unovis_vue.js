import {
  ...
  XYContainer,
  XYLabels
} from "./chunk-TFGLPLFU.js";
import {
  isEqual
} from "./chunk-6U7HG5KB.js";
...
import {
  ...
  watch,
  watchEffect
} from "./chunk-F34BDRMP.js";
import "./chunk-E5EEIGMK.js";

// node_modules/@unovis/vue/utils/context.js
var o = /* @__PURE__ */ Symbol("componentAccessorKey");
var s = /* @__PURE__ */ Symbol("tooltipAccessorKey");
var c = /* @__PURE__ */ Symbol("crosshairAccessorKey");
var e = /* @__PURE__ */ Symbol("axisAccessorKey");
var t = /* @__PURE__ */ Symbol("annotationsAccessorKey");
...
var b = defineComponent({
  ...
  setup(c2, { expose: d }) {
    ...
    return watchEffect(() => {
      ...
      component: o2
    }), (t2, B5) => (openBlock(), createElementBlock("div", {
...
var S2 = { "data-vis-axis": "" };
var A = Axis.selectors;
var C = defineComponent({
  ...
  setup(p, { expose: u }) {
    const o2 = inject(e), a = p, i = computed(() => o2.data.value ?? a.data), n = m(a), t2 = ref();
    return onMounted(() => {
      nextTick(() => {
        var e2;
        t2.value = new Axis(n.value), (e2 = t2.value) == null || e2.setData(i.value), o2.update(t2.value);
      });
    }), onUnmounted(() => {
      var e2;
      ...
      var l;
      f(e2, c2) || (l = t2.value) == null || l.setConfig(n.value);
    }), watch(i, () => {
      var e2;
      (e2 = t2.value) == null || e2.setData(i.value);
    }), u({
      component: t2
    }), (e2, c2) => (openBlock(), createElementBlock("div", S2));
  }
});

// node_modules/@unovis/vue/components/brush/index.js
var S3 = { "data-vis-component": "" };
...
var E = defineComponent({
  ...
  setup(l, { expose: p }) {
    ...
    return onMounted(() => {
      ...
      component: t2
    }), (e2, s2) => (openBlock(), createElementBlock("div", S3));
  }
});
...
var S4 = defineComponent({
  ...
  setup(u, { expose: p }) {
    ...
    return onMounted(() => {
      ...
      component: t2
    }), (e2, r) => (openBlock(), createElementBlock("div", b2));
  }
});
...
var O2 = { "data-vis-component": "" };
var k4 = Plotband.selectors;
var w5 = defineComponent({
  ...
  setup(r, { expose: s2 }) {
    const n = inject(o), t2 = m(r), e2 = ref();
    return onMounted(() => {
      nextTick(() => {
        e2.value = new Plotband(t2.value), n.update(e2.value);
      });
    }), onUnmounted(() => {
      var o2;
      (o2 = e2.value) == null || o2.destroy(), n.destroy();
    }), watch(t2, (o2, a) => {
      var c2;
      f(o2, a) || (c2 = e2.value) == null || c2.setConfig(t2.value);
    }), s2({
      component: e2
    }), (o2, a) => (openBlock(), createElementBlock("div", O2));
  }
});

// node_modules/@unovis/vue/components/plotline/index.js
var O3 = { "data-vis-component": "" };
var k5 = Plotline.selectors;
var w6 = defineComponent({
  ...
  setup(s2, { expose: i }) {
    const n = inject(o), t2 = m(s2), e2 = ref();
    return onMounted(() => {
      nextTick(() => {
        e2.value = new Plotline(t2.value), n.update(e2.value);
      });
    }), onUnmounted(() => {
      var o2;
      (o2 = e2.value) == null || o2.destroy(), n.destroy();
      ...
      var a;
      f(o2, l) || (a = e2.value) == null || a.setConfig(t2.value);
    }), i({
      component: e2
    }), (o2, l) => (openBlock(), createElementBlock("div", O3));
  }
});
...
var P2 = defineComponent({
  ...
  setup(p, { expose: d }) {
    ...
    return onMounted(() => {
      ...
      component: t2
    }), (e2, r) => (openBlock(), createElementBlock("div", L2));
  }
});
...
var S5 = { "data-vis-component": "" };
var w7 = Treemap.selectors;
var C3 = defineComponent({
  ...
  setup(u, { expose: d }) {
    const o2 = inject(o), l = u, a = computed(() => o2.data.value ?? l.data), n = m(l), t2 = ref();
    return onMounted(() => {
      nextTick(() => {
        var e2;
        t2.value = new Treemap(n.value), (e2 = t2.value) == null || e2.setData(a.value), o2.update(t2.value);
      });
    }), onUnmounted(() => {
      var e2;
      (e2 = t2.value) == null || e2.destroy(), o2.destroy();
      ...
      var r;
      f(e2, i) || (r = t2.value) == null || r.setConfig(n.value);
    }), watch(a, () => {
      var e2;
      (e2 = t2.value) == null || e2.setData(a.value);
    }), d({
      component: t2
    }), (e2, i) => (openBlock(), createElementBlock("div", S5));
  }
});
...
var z2 = defineComponent({
  ...
  setup(c2, { expose: l }) {
    ...
    return onMounted(() => {
      ...
      var a;
      f(e2, n) || (a = o2.value) == null || a.setConfig(t2.value);
    }), l({
      component: o2
...
var w8 = defineComponent({
  ...
  setup(c2, { expose: d }) {
    const i = c2, o2 = computed(() => i.data), n = m(i), t2 = ref(), a = ref();
    return onMounted(() => {
      nextTick(() => {
        a.value && (t2.value = new LeafletMap(a.value, n.value, o2.value));
      });
    }), onUnmounted(() => {
      var e2;
      (e2 = t2.value) == null || e2.destroy();
    }), watch(n, (e2, l) => {
      var p;
      f(e2, l) || (p = t2.value) == null || p.setConfig(n.value);
    }), watch(o2, () => {
      var e2;
      (e2 = t2.value) == null || e2.setData(o2.value);
    }), d({
      component: t2
    }), (e2, l) => (openBlock(), createElementBlock("div", {
...
var k6 = LeafletFlowMap.selectors;
var b4 = defineComponent({
  ...
  setup(s2, { expose: d }) {
    const i = s2, o2 = computed(() => i.data), n = m(i), t2 = ref(), a = ref();
    return onMounted(() => {
      nextTick(() => {
        a.value && (t2.value = new LeafletFlowMap(a.value, n.value, o2.value));
      });
    }), onUnmounted(() => {
      var e2;
      (e2 = t2.value) == null || e2.destroy();
      ...
      var r;
      f(e2, l) || (r = t2.value) == null || r.setConfig(n.value);
    }), watch(o2, () => {
      var e2;
      (e2 = t2.value) == null || e2.setData(o2.value);
    }), d({
...
var h = RollingPinLegend.selectors;
var w9 = defineComponent({
  ...
  setup(c2, { expose: d }) {
    const l = c2;
    computed(() => l.data);
    const n = m(l), o2 = ref(), t2 = ref();
    return onMounted(() => {
      nextTick(() => {
        t2.value && (o2.value = new RollingPinLegend(t2.value, n.value));
      });
    }), onUnmounted(() => {
      var e2;
      (e2 = o2.value) == null || e2.destroy();
      ...
      var a;
      f(e2, r) || (a = o2.value) == null || a.setConfig(n.value);
    }), d({
      component: o2
    }), (e2, r) => (openBlock(), createElementBlock("div", {
...
(function() {
  ...
  try {
    if (typeof document < "u") {
      ...
      e2.appendChild(document.createTextNode(".unovis-xy-container,.unovis-single-container{display:block;position:relative;width:100%}[data-vis-leaflet-map],[data-vis-leaflet-flow-map]{display:block;position:relative}[data-vis-bullet-legend],[data-vis-rolling-pin-legend]{display:block}")), document.head.appendChild(e2);
    }
  } catch (i) {
...
export {
  ...
  y2 as VisBulletLegendSelectors,
  ...
  D6 as VisGraph,
  B4 as VisGraphSelectors,
  D4 as VisGroupedBar,
  w as VisGroupedBarSelectors,
  b4 as VisLeafletFlowMap,
  k6 as VisLeafletFlowMapSelectors,
  w8 as VisLeafletMap,
  F3 as VisLeafletMapSelectors,
  S4 as VisLine,
  O as VisLineSelectors,
  P2 as VisNestedDonut,
  E4 as VisNestedDonutSelectors,
  w5 as VisPlotband,
  k4 as VisPlotbandSelectors,
  w6 as VisPlotline,
  k5 as VisPlotlineSelectors,
  w9 as VisRollingPinLegend,
