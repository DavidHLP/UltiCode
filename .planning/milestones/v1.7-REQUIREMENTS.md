# Requirements Archive: v1.7 Notifications
...
- [x] **NOTIF-01**: User receives real-time in-app notification via WebSocket when a notification is created
- [x] **NOTIF-02**: User receives real-time WebSocket push when an achievement is earned (fix AchievementNotificationListener)

### Notification Triggers

- [x] **NOTIF-03**: User receives notification when someone follows them (follow trigger wired to notification service)
- [x] **NOTIF-04
