...
**Context:** Adding Arthas MCP (Model Context Protocol) server to a Spring Boot project managed by PM2, so Claude Code can call Arthas diagnostic tools directly.
