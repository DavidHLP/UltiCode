...
- Active task: P0-SEC-006 Redis ACL command/key isolation; P0-SEC-004 and P0-SEC-005 are complete.
...
- Next: restrict Redis principals by exact commands and key/channel patterns; then verify deployment SSH identity and Nacos credentials.
