...
- Active task: P0-SEC-004 shared JWT/JWKS resource security.
...
- Next: compare and converge the three resource verifiers/four filters, then commit JWT/JWKS RED tests for algorithm, issuer, audience, type, kid, key strength, rotation, and HTTP JWKS rejection.
