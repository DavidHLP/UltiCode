...
module.exports = {
  apps: [
    ...
    },
    {
      ...
      env: {
        SERVER_PORT: '9102',
        APP_FEATURES_CONTEST_DUBBO_CUTOVER: process.env.APP_FEATURES_CONTEST_DUBBO_CUTOVER || 'false',
    ...
    },
    {
      ...
      env: {
        ...
        APP_FEATURES_JUDGE_QUEUE_ENVELOPE_VERSION: process.env.APP_FEATURES_JUDGE_QUEUE_ENVELOPE_VERSION || '2',
