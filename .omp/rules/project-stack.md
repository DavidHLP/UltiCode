---
name: project-stack
description: Database, frontend, shared-package, operations, documentation, and cross-stack rules for UltiCode.
globs:
  - init-db/**/*.sql
  - init-db/**/*.conf
  - scripts/dev/**/*
...
condition: ["(?i)database|Flyway|Vue|TypeScript|Compose|migration|contract|security"]
interruptMode: never
alwaysApply: false
---
