...
- Exceptions **MUST NOT** implement normal control flow. Validate predictable null, range, format, and state conditions before invoking operations that would fail.
