export default {
  ...
  common: {
    ...
    error: {
      fetchFailed: 'Failed to fetch {entity}',
  ...
  storeErrors: {
    ...
    problems: {
      fetchFailed: 'Failed to fetch problems',
      fetchOneFailed: 'Failed to fetch problem',
    ...
    contests: {
      fetchFailed: 'Failed to fetch contests',
      fetchOneFailed: 'Failed to fetch contest',
      createFailed: 'Failed to create contest',
      updateFailed: 'Failed to update contest',
      deleteFailed: 'Failed to delete contest',
      startFailed: 'Failed to start contest',
      endFailed: 'Failed to end contest',
      bulkDeleteFailed: 'Failed to bulk delete contests',
    },
    tags: {
    ...
    problemLists: {
      fetchFailed: 'Failed to fetch problem lists',
      fetchOneFailed: 'Failed to fetch problem list',
      ...
      updateProblemsFailed: 'Failed to update problems',
    },
    solutions: {
      fetchFailed: 'Failed to fetch solutions',
      fetchOneFailed: 'Failed to fetch solution',
      deleteFailed: 'Failed to delete solution',
      flagFailed: 'Failed to flag solution',
      unflagFailed: 'Failed to unflag solution',
    },
    forum: {
      fetchFailed: 'Failed to fetch forum posts',
      fetchOneFailed: 'Failed to fetch forum post',
      deleteFailed: 'Failed to delete forum post',
      pinFailed: 'Failed to pin post',
      unpinFailed: 'Failed to unpin post',
      lockFailed: 'Failed to lock post',
      unlockFailed: 'Failed to unlock post',
      flagFailed: 'Failed to flag post',
      unflagFailed: 'Failed to unflag post',
    },
    comments: {
  ...
  // API Toast messages for success responses
  apiToast: {
    users: {
      ...
      batchProcessed: '{count} users processed successfully',
    },
    audit: {
    ...
    problems: {
      ...
      restored: 'Problem restored successfully',
    },
    contests: {
      ...
      problemAdded: 'Problem added to contest',
      problemRemoved: 'Problem removed from contest',
      batchProcessed: '{count} contests processed successfully',
    },
    tags: {
      ...
      batchProcessed: '{count} tags processed successfully',
    },
    problemLists: {
      created: 'Problem list created successfully',
      updated: 'Problem list updated successfully',
      deleted: 'Problem list deleted successfully',
      problemsUpdated: 'Problems updated successfully',
    },
    solutions: {
      unflagged: 'Solution unflagged successfully',
      deleted: 'Solution deleted successfully',
      flagged: 'Solution flagged successfully',
    },
    forum: {
      unpinned: 'Post unpinned successfully',
      pinned: 'Post pinned successfully',
      unlocked: 'Post unlocked successfully',
      locked: 'Post locked successfully',
      unflagged: 'Post unflagged successfully',
